...
local library = {
	...
	draggable = true,
	flags = {},
	title = "Astrohook - version 1.2 | updated: 10/7/22",
	open = false,
	...
	tabSize = 0,
	theme = {},
	foldername = "Astrohook/universal",
	fileext = ".sex"
}
...
SettingSection:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(255, 0, 149), callback = function(color)
...
-- [Tile Size Slider]
SettingSection:AddSlider({text = "Tile Size", min = 50, max = 500, value = 113, callback = function(size)
    if library.main then
...
SettingSection:AddButton({text = "Discord", callback = function()
    ...
    setclipboard("https://discord.gg/jWrXKYmRm3")
    toclipboard("https://discord.gg/jWrXKYmRm3")
end});
